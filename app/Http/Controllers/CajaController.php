...
class CajaController extends Controller
{
  ...
  public function getDataMovimientos(Request $request)
  {
    ...
    try {
      ...
      $fechaInicialFormateada = $localizador->format($fechaInicial);
      $fechaFinalFormateada = $localizador->format($fechaFinal);
    ...
    $totalHistoricofin = $totalValoresHistorico->efectivo + $totalValoresHistorico->transferencia;
      ...
      $response = ["status" => false, "message" => "consultado correctamente", "error" => $e->getMessage()];
    }
