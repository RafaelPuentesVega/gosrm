...
<div class="wrapper">
                                    ...
                                    <table class="table" id="miTabla" class="display">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 8%;">Ruta Soporte</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div id="movimientos" style="display: none">
                                ...
                                <div class="card " style="box-shadow: 2px 2px 8px 0 rgba(0,0,0,.2)">
                                    ...
                                    <div class="content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select required style="appearance:none;" class="js-example-basic js-states form-control" name="tipo" id="tipo">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input required oninput="formatoSeparadorMil(this)" type="text" id="valor" name="valor" class="form-control" placeholder="" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="metodo_pago">Metodo Pago</label>
                                                        <select required style="appearance:none;" class="js-example-basic js-states form-control" name="metodo_pago" id="metodo_pago">
                                                            <option selected value="">-</option>
                                                ...
                                                <div class="col-md-2" id="soporte_div" style="display: none" >
                                                    <div class="form-group">
                                                        <label for="soporte" >Soporte</label>
                                                        <input type="file" class="form-control btn-upload" name="soporte" id="soporte"   autocomplete="off">
                                                    </div>
                                                </div>
                                                <div style="display: none"   id="numero_orden_div"  class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Nro. Orden</label>

                                                        <input type="text" class="form-control" name="numero_orden" id="numero_orden" placeholder="" autocomplete="off">
                                        ...
                                        <!-- Button  modal -->
                                        <button title="Guardar" data-toggle="tooltip" id="btn-guardar" data-placement="bottom" style=" border: none;  margin: 10px" type="button" class="btn btn-primary btn-fill  pull-right ">
    ...
    <script src="{!! url('js/caja.js?v=1.2') !!}"></script>
